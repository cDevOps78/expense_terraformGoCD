...
resource "null_resource" "null" {
  provisioner "remote-exec" {
    ...
    inline = [
            ...
            "ansible-pull -i localhost,-U https://github.com/cDevOps78/expenseAnsibleGoCD -e env=${var.env_m} -e component=${var.component_m} -e vault_token=${var.vault_token} get-vault-secrets.yaml",
